...
public class Main {
    public static void main(String[] args) {
        ...
        Administrador admin = new Administrador("Jose", "Soriano", "jose@gmail.com", "josesor", "1234");
        Propietario owner1 = new Propietario("Pablo", "González", "pgonzalez@gmail.com", "palez", "5678");
        Propietario owner2 = null, ownerLogueado;
        Usuario user1 = new Usuario("Eva", "Navarro", "eva@gmai.com", "evavarro", "9123");
        ...
        do {
            ...
            switch (opInicial) {
                case "1": //Iniciar sesión
                    ...
                    if (userNameTeclado.equals(admin.getUserName()) && claveTeclado.equals(admin.getClave())) { // IS admin
                        do {
                            logueado = true;
                    ...
                    if (ownerLogueado != null) {
                        do {
                            ...
                            System.out.println("""
                                    ...
                                    6.- Establever un periodo de no disponible para una vivienda
                                    7.- Ver mi perfil
                            ...
                            switch (opPrincipal) {
                                ...
                                case "3": // Eliminar vivienda
                                    ...
                                    else ownerLogueado.setVivienda(null);
                                    break;
                            ...
                            switch (opPrincipal) {
                                case "1": //Busqueda de alojamientos
                                    ...
                                    if (v1 != null && !userLogueado.puedeReservar() ||
                                        ...
                                        if (v2 != null && userLogueado.puedeReservar() &&
                                                userLogueado.getReserva2().getVivienda().coincideCiudad(ciudadTeclado) &&
                                                (userLogueado.getReserva2().getVivienda().suficientesHuespedes(huespedes)) &&
                                ...
                                case "3": //Cancelar reservas
                                    ...
                                    if (userLogueado.getReserva1() == null && userLogueado.getReserva2() == null)
                                        ...
                                        if (!idReservaTeclado.equals(userLogueado.getReserva1().getIdReserva()) &&
                                            ...
                                            if (idReservaTeclado.equals(userLogueado.getReserva2().getIdReserva()))
