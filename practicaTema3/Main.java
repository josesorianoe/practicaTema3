                                        ...
                                        switch (op) {
                                            case "1": // Establecer un periodo de no disponible
                                                if (ownerLogueado.getVivienda().getReserva1() != null &&
                                                    ...
                                                    System.out.print("Introduzca número de noches que va a reservar: ");
                                                    noches = Integer.parseInt(s.nextLine());
                                                    LocalDate fechaFin = fechaInicio.plusDays(noches);

                                                    if (ownerLogueado.getVivienda().getReserva1() == null) { //La primera reserva de la vivienda
                                                        if (r1 == null && !reservaAplicada){ // Si r1 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva1(r1 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva1().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva1().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r2 == null && !reservaAplicada){ // Si r2 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva1(r2 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva1().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva1().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r3 == null && !reservaAplicada){ // Si r3 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva1(r3 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva1().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva1().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r4 == null && !reservaAplicada){ // Si r4 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva1(r4 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva1().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva1().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                    } else { //La segunda reserva de la vivienda
                                                        if (r1 == null && !reservaAplicada){ // Si r1 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva2(r1 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva2().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva2().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r2 == null && !reservaAplicada){ // Si r2 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva2(r2 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva2().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva2().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r3 == null && !reservaAplicada){ // Si r3 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva2(r3 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva2().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva2().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                        if (r4 == null && !reservaAplicada){ // Si r4 es null
                                                            reservaAplicada = true;
                                                            ownerLogueado.getVivienda().setReserva2(r4 = new Reserva(noches, fechaInicio));
                                                            ownerLogueado.getVivienda().getReserva2().setVivienda(ownerLogueado.getVivienda());
                                                            ownerLogueado.getVivienda().getReserva2().calculaFechaSalida(fechaInicio, noches);
                                                        }
                                                    }
                        ...
                        do {
                            ...
                            switch (opPrincipal) {
                                case "1": //Busqueda de alojamientos
                                    ...
                                    noches = Integer.parseInt(s.nextLine());
                                    Utils.limpiarPantalla();
                                    //TODO Error. Peta si no hay otro usuario registrado
                                    ...
                                    if (userLogueado.getReserva1() == null && userLogueado.getReserva2() == null)
                                        ...
                                        if (!idReservaTeclado.equals(userLogueado.getReserva1().getIdReserva()) &&
                                            ...
                                            if (idReservaTeclado.equals(userLogueado.getReserva1().getIdReserva())){// Primera reserva del usuario
                                                ...
                                                if (r1 != null && !reservaCancelada && userLogueado.getReserva1().getIdReserva().equals(r1.getIdReserva())){// ocupa r1 en memoria
                                                    reservaCancelada = true;
                                                    r1 = null;
                                                }
                                                if (r2 != null && !reservaCancelada && userLogueado.getReserva1().getIdReserva().equals(r2.getIdReserva())){ // ocupa r2 en memoria
                                                    reservaCancelada = true;
                                                    r2 = null;
                                                }
                                                if (r3 != null && !reservaCancelada && userLogueado.getReserva1().getIdReserva().equals(r3.getIdReserva())){// ocupa r3 en memoria
                                                    reservaCancelada = true;
                                                    r3 = null;
                                                }
                                                if (r4 != null && !reservaCancelada && userLogueado.getReserva1().getIdReserva().equals(r4.getIdReserva())){// ocupa r4 en memoria
                                                    reservaCancelada = true;
                                                    r4 = null;
                                                }
                                            ...
                                            if (userLogueado.getReserva2() != null && idReservaTeclado.equals(userLogueado.getReserva2().getIdReserva()) && !reservaCancelada){ // Segunda reserva del usuario
                                                if (r1 != null && !reservaCancelada && userLogueado.getReserva2().getIdReserva().equals(r1.getIdReserva())){// ocupa r1 en memoria
                                                    reservaCancelada = true;
                                                    r1 = null;
                                                }
                                                if (r2 != null && !reservaCancelada && userLogueado.getReserva2().getIdReserva().equals(r2.getIdReserva())){// ocupa r2 en memoria
                                                    reservaCancelada = true;
                                                    r2 = null;
                                                }
                                                if (r3 != null && !reservaCancelada && userLogueado.getReserva2().getIdReserva().equals(r3.getIdReserva())){// ocupa r3 en memoria
                                                    reservaCancelada = true;
                                                    r3 = null;
                                                }
                                                if (r4 != null && !reservaCancelada && userLogueado.getReserva2().getIdReserva().equals(r4.getIdReserva())){// ocupa r4 en memoria
                                                    reservaCancelada = true;
                                                    r4 = null;
                                                }
